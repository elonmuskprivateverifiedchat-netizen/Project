...
// Some plugins use `require` to resolve dependencies during build.
...
async function buildAll() {
  const distDir = "dist";
  await rm(path.join(artifactDir, distDir), { recursive: true, force: true });
  ...
  await esbuild({
    ...
    bundle: true,
    format: "esm",
    outdir: path.join(artifactDir, distDir),
    outExtension: { ".js": ".mjs" },
    logLevel: "info",
